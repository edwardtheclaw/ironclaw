...
impl McpClient {
    ...
    pub async fn create_tools(&self) -> Result<Vec<Arc<dyn Tool>>, ToolError> {
        ...
        Ok(mcp_tools
            .into_iter()
            .map(|t| {
                let prefixed_name = format!("{}:{}", self.server_name, t.name);
...
mod tests {
    ...
    fn test_mcp_tool_wrapper_name_is_prefixed() {
        ...
        let wrapper = McpToolWrapper {
            ...
            prefixed_name: "myserver:do_thing".to_string(),
            client,
        };
        assert_eq!(wrapper.name(), "myserver:do_thing");
    }
    ...
    fn test_mcp_tool_wrapper_description() {
        ...
        let wrapper = McpToolWrapper {
            tool: make_test_mcp_tool(false),
            prefixed_name: "s:do_thing".to_string(),
            client,
        };
