...
///
/// When `suppress_stderr` is true, the fmt layer that writes to stderr is
/// omitted. This is used in TUI mode where logs are captured into a ring
/// buffer and displayed in a dedicated Logs tab instead.
pub fn init_tracing(
