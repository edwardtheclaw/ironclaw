...
I18n.register('zh-CN', {
  ...
  // 调试面板
  'debug.title': '调试面板',
  'debug.togglePanel': '切换调试面板',
  'debug.tabPrompt': '提示词',
  'debug.tabActivity': '活动',
  'debug.tabStats': '统计',
  'debug.promptRefresh': '刷新',
  'debug.promptTotal': '预估总 Token 数',
  'debug.promptEmpty': '暂无提示词组件',
  'debug.promptFull': '完整系统提示词',
  'debug.promptError': '加载提示词数据失败',
  'debug.activityEmpty': '暂无事件。发送消息即可开始。',
  'debug.activityCleared': '时间线已清空',
  'debug.activityTurn': '轮次',
  'debug.activityPrevTurn': '上一轮',
  'debug.activityNextTurn': '下一轮',
  'debug.activityLatest': '最新',
  'debug.activityLlmCall': 'LLM 调用',
  'debug.activityToolStart': '工具启动',
  'debug.activityToolComplete': '工具完成',
  'debug.activityThinking': '思考中',
  'debug.activityStatus': '状态',
  'debug.activityReasoning': '推理中',
  'debug.activityResponse': '响应',
  'debug.activityError': '错误',
  'debug.statsTurns': '对话轮次',
  'debug.statsTotalTokens': '总 Token',
  'debug.statsInputTokens': '输入 Token',
  'debug.statsOutputTokens': '输出 Token',
  'debug.statsCost': '预估费用',
  'debug.statsToolCalls': '工具调用',
  'debug.statsModelUsage': '各模型用量',
  'debug.statsNoModels': '暂无模型数据',
  'debug.statsSseHealth': 'SSE 健康状态',
  'debug.statsSseConnected': '已连接',
  'debug.statsSseDisconnected': '已断开',
