...
pub use channel::{
    AttachmentKind, Channel, ChannelSecretUpdater, HistoryMessage, IncomingAttachment,
    IncomingMessage, MessageStream, OutgoingResponse, StatusUpdate, ThreadSummary, ToolDecision,
